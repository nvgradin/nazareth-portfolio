...
export const lasIslasCies: ProjectWithLayout = {
  ...
  layout: {
    ...
    // Modelo escalable — 4 islas con stats animados
    islandScale: {
      label: 'Resultado',
      title: 'Un producto diseñado para escalar',
      subtitle: 'Cuatro destinos. Una arquitectura.',
      body: 'Lo que construí para Las Islas Cíes no fue una solución única — fue un sistema replicable. En menos de ocho meses, el mismo modelo se adaptó a tres destinos más, cada uno con su identidad, su contenido y su integración propia.',
      background: '#252851',
      stats: [
        { id: 'portales', target: 4, label: 'portales' },
        { id: 'meses', target: 8, label: 'meses' },
        { id: 'arquitectura', target: 1, label: 'arquitectura' },
      ],
      items: [
        {
          number: '01',
          name: 'Las Islas Cíes',
          date: 'Oct 2024',
          description: 'El origen del sistema. Rediseño completo y arquitectura de contenido desde cero.',
          logo: { src: '/logos/Las_Islas_Cies.png', alt: 'Las Islas Cíes' },
          mockup: '/projects/las-islas-cies/MockupWeb1_LasIslasCies.jpg',
        },
        {
          number: '02',
          name: 'Isla de Ons',
          date: 'Dic 2024',
          description: 'Primera replicación del modelo. Lanzada 6 semanas después de Cíes.',
          logo: { src: '/logos/EU_ONS.png', alt: 'Isla de Ons' },
          mockup: '/projects/las-islas-cies/MockupWeb1_LasIslasCies.jpg',
        },
        {
          number: '03',
          name: 'Isla de Lobos',
          date: 'Ene 2025',
          description: 'Construida de cero. Contenido redactado íntegramente.',
          logo: { src: '/logos/I_LOVE_LOBOS.png', alt: 'Isla de Lobos' },
          mockup: '/projects/las-islas-cies/MockupWeb1_LasIslasCies.jpg',
        },
        {
          number: '04',
          ...
          date: 'Abr 2025',
          description: 'Mayor alcance geográfico. Propuesta de experiencias ampliada.',
          logo: { src: '/logos/I_LOVE_LA_GRACIOSA.png', alt: 'Isla de la Graciosa', scale: 1.3 },
          mockup: '/projects/las-islas-cies/MockupWeb1_LasIslasCies.jpg',
        },
      ],
    },
